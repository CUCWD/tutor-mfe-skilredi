...
def load_about():
    about = {}
    with io.open(
        os.path.join(HERE, "tutormfe_skilredi", "__about__.py"), "rt", encoding="utf-8"
    ) as f:
...
setup(
    ...
    entry_points={"tutor.plugin.v1": ["mfe-skilredi = tutormfe_skilredi.plugin"]},
    classifiers=[
